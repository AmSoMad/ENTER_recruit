...
@Component
public class EnterUtilsDialect extends AbstractDialect implements IExpressionObjectDialect {

	protected EnterUtilsDialect() {
		super("enterUtils");
	}
    ...
    public IExpressionObjectFactory getExpressionObjectFactory() {
        return new IExpressionObjectFactory() {
            ...
            public Set<String> getAllExpressionObjectNames() {
                return Collections.singleton("enterUtils");
            }
